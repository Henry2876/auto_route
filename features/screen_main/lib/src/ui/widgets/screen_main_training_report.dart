...
class ScreenMainTrainingReport extends StatelessWidget {
  const ScreenMainTrainingReport({super.key});
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            ScreenMainAverageValue(title: 'Усталость мышц за неделю:', value: '70%'),
          ],
        ),
      );
    }
